...
label daeun_first_meeting:
    ...
    menu: 
        "...넌 말 잘하네.": # 긍정
            p "...넌 말 잘하네."
            jump daeun_first_meeting_branch_a1

        "(아무 말 없이 시선을 피한다.)": # 평범 
            "(아무 말 없이 시선을 피한다.)"
            jump daeun_first_meeting_branch_a
...
# 선택지 공통
label daeun_first_meeting_branch_a:
...
# 선택지 긍정
label daeun_first_meeting_branch_a1:
    hide daeun_1
    show daeun_2 at center 
    de "그냥 말 안하면, 더 낯설잖아..."
